...
def register_blueprints(app):
    ...
    # ---- Phase 2 blueprints (analytics & smart-care additions) ----
    from app.blueprints.followups import bp as followups_bp
    from app.blueprints.surgery import bp as surgery_bp
