...
@bp.route("/alerts")
def alerts():
    # Real schema: CK_alert_status only allows 'Unreviewed' | 'ConfirmedByNurse' | 'Resolved'.
...
def acknowledge_alert(alert_id):
    ...
    # Matches sp_AcknowledgeAlert / the text spec's own wording exactly:
    # "unreviewed, confirmed by nurse, resolved."
